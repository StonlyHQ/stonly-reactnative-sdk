...
const withStonlyAndroid = (config, { widgetId, androidUrlScheme }) => {
  ...
  if (androidUrlScheme) {
    ...
    config = (0, config_plugins_1.withAndroidManifest)(config, (config) => {
      var _a;
      const mainActivity =
        config_plugins_1.AndroidConfig.Manifest.getMainActivityOrThrow(
          config.modResults
        );
      // Find existing intent-filter or create new one
      let intentFilter =
        (_a = mainActivity['intent-filter']) === null || _a === void 0
          ? void 0
          : _a.find((filter) => {
              var _a;
              return (_a = filter.data) === null || _a === void 0
                ? void 0
                : _a.some((data) => {
                    var _a;
                    return (_a = data.$) === null || _a === void 0
                      ? void 0
                      : _a['android:scheme'];
                  });
            });
      ...
      schemes.forEach((scheme) => {
        ...
        const existingScheme =
          (_a = intentFilter.data) === null || _a === void 0
            ? void 0
            : _a.find((data) => {
                var _a;
                return (
                  ((_a = data.$) === null || _a === void 0
                    ? void 0
                    : _a['android:scheme']) === scheme
                );
              });
        if (!existingScheme) {
